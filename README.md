...
This project was developed with OpenAI Codex as an AI-assisted coding tool. The tool was used to scaffold the application, implement components and routes, and run lint, type-check, build, and local verification commands. Design and implementation scope were kept aligned with the assignment's frontend-only requirement.
